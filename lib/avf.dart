...
class avf extends StatefulWidget {
  final String csvFilePath;
  avf({required this.csvFilePath});

  @override
  _avfState createState() => _avfState();
}

class _avfState extends State<avf> {
  ...
  Widget _buildAnimatedChart(List<List<double>> data) {
    return Column(
      ...
      children: [
      Text('GRAPH-AVF', // Replace with your desired title
      style: TextStyle(
        fontSize: 18,
