...
class Lead3 extends StatefulWidget {
  final String csvFilePath;
  Lead3({required this.csvFilePath});

  @override
  _Lead3State createState() => _Lead3State();
}

class _Lead3State extends State<Lead3> {
  ...
  Widget _buildAnimatedChart(List<List<double>> data) {
    return Column(
      ...
      children: [
      Text('Lead3', // Replace with your desired title
      style: TextStyle(
        fontSize: 18,
